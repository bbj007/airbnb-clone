...
class Amenity(AbstractItem):
    """Amentiy Object Defition"""
    class Meta:
        verbose_name_plural = "Amenities"

class Facility(AbstractItem):
    """Facility Model Defition"""
    class Meta:
        verbose_name_plural = "Facilities"

class HouseRule(AbstractItem):
    """HouseRule Model Defition"""
    class Meta:
...
class Room(core_models.TimeStampedModel):
    ...
    host = models.ForeignKey("users.User",related_name="rooms", on_delete=models.CASCADE, null=True)
